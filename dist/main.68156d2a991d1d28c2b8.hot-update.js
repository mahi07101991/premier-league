...
function (_Component) {
  ...
  function index(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "goToDetailPage", function (id) {
      if (_this.props.updateMatchDetails(id)) _this.props.history.push("/dashboard/match/".concat(id));
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "getDateFilter", function () {
      ...
      }, [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019].map(function (item) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          className: "dropdown-item",
          key: item,
          onClick: function onClick() {
            _this.props.searchMatches(item);
          }
        }, item);
      })));
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "getTabletRows", function () {
      return _this.props.matches.map(function (item, i) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          title: "View More"
        }, "click here\xA0", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
          className: "fa fa-chevron-circle-right",
          "aria-hidden": "true"
        }))))));
      });
  ...
  _createClass(index, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        id: "pagination"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, this.props.matches.length > 0 && "".concat(this.props.pageNumber, " - ").concat(this.props.matches.length, " of ").concat(this.props.totalMatches)), this.props.overview === true && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        onClick: function onClick() {
      ...
      })), this.props.overview === true && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        onClick: function onClick() {
          if (_this3.props.page >= 0) {
...
//# sourceMappingURL=main.68156d2a991d1d28c2b8.hot-update.js.map