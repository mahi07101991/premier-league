...
function incMatches(page) {
  debugger;
  return function (dispatch) {
    return Object(_services__WEBPACK_IMPORTED_MODULE_0__["default"])("http://localhost:5000/api/matches/".concat(page + 70), "GET").then(function (response) {
      dispatch({
        type: "INC_MATCHES",
        matches: response.data
      });
...
//# sourceMappingURL=main.b8554addb3d96851e526.hot-update.js.map