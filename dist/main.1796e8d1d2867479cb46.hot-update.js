...
function searchMatches(value) {
  debugger;
  return function (dispatch) {
    return Object(_services__WEBPACK_IMPORTED_MODULE_0__["default"])("http://localhost:5000/api/find/".concat(value), "GET").then(function (response) {
      dispatch({
        type: "LOAD_MATCHES",
        data: response.data
      });
...
//# sourceMappingURL=main.1796e8d1d2867479cb46.hot-update.js.map