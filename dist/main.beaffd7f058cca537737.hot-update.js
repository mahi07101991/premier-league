...
function (_Component) {
  ...
  function index(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "goToDetailPage", function (id) {
      if (_this.props.actions.updateMatchDetails(id)) ;

      _this.props.history.push("/dashboard/match/".concat(id));
    });
...
//# sourceMappingURL=main.beaffd7f058cca537737.hot-update.js.map